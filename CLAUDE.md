...
### 📝 Правило: state.md (обязательно)

После каждого значимого шага (закончил подзадачу, нашёл проблему, принял решение) — ОБНОВИ `output/session/state.md` обычным Write:
...
Перед тем как сказать что задача завершена — обнови state.md.
